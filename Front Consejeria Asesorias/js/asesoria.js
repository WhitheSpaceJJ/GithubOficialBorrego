...
function validarCodigoPostal() {
  ...
  fetch(`http://localhost:3001/codigospostales/cp/${codigoPostal}`, {
    ...
    .then(data => {
      ...
      document.getElementById('txtEstadoIT2').value =
        data.colonias.estado.nombre_estado
      document.getElementById('txtMunicipioIT2').value =
        data.colonias.municipio.nombre_municipio
      document.getElementById('txtCiudadIT2').value =
        data.colonias.ciudad.nombre_ciudad
...
function validarCamposAsesorado() {
  ...
  const apellidoPaternoAsesoradoIT2 = document.getElementById(
    'apellidoPaternoAsesoradoIT2'
  )
  if (apellidoPaternoAsesoradoIT2 === null) {
    return false
  }

  const apellidoMaternoAsesoradoIT2 = document.getElementById(
    'apellidoMaternoAsesoradoIT2'
  )
...
function registarAsesoria() {
  ...
  const apellidoPaternoAsesorado = document.getElementById(
    'apellidoPaternoAsesoradoIT2'
  ).value
  persona.apellido_materno = apellidoPaternoAsesorado
  const apellidoMaternoAsesorado = document.getElementById(
    'apellidoMaternoAsesoradoIT2'
  ).value
  ...
  const telefonoAsesorado = document.getElementById(
    'telefonoAsesoradoIT2'
  ).value
  ...
  const confirmacionCumple = document.getElementById(
    'confirmacionCumpleIT1'
  ).checked
  const negacionCumple = document.getElementById('negacionCumpleIT1').checked
  const estatus_requisitos = confirmacionCumple
    ? true
    : negacionCumple
    ? false
    : 'nada'
  ...
  const ingresoSeleccionado = ingresoMenor
    ? 9999
    : ingresoMayor
    ? 10001
    : 'nada'
...
function rellenarDatosVerificacion() {
  ...
  nombreAsesorIT32.innerHTML =
    nombreAsesor.options[nombreAsesor.selectedIndex].text
  const tipoJuicioAplicaLabel2 = document.getElementById('tipoJuicioIT3')
  tipoJuicioAplicaLabel2.innerHTML =
    tipoJuicioAplica.options[tipoJuicioAplica.selectedIndex].text
  ...
  nombreAsesoradoLabel2.innerHTML =
    nombreAsesorado.value +
    ' ' +
    apellidoPaternoAsesorado.value +
    ' ' +
    apellidoMaternoAsesorado.value
