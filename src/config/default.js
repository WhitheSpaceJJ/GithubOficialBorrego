...
const DATABASE = process.env.DATABASE || 'codigospostalesdb'; // Obtenemos el valor de la variable de entorno DATABASE o usamos consejeria por defecto
const PORT = process.env.PORT || 3000; // Obtenemos el valor de la variable de entorno PORT o usamos el puerto 3000 por defecto
